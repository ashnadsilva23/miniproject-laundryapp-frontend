...
import './sidebar.css'; // Make sure to include the CSS file
    ...
    <div className="main-sidebar">
      ...
      <div className="dropdown-container">
        ...
        {activeDropdown === 'services' && ( // Check if 'services' dropdown is active
          <ul className="dropdown-content">
            <li><a href="/addservice">Add Services</a></li>
            <li><a href="/viewservice"> view Service </a></li>
            <li><a href="/searchservice"> Search Service </a></li>
      ...
      <div className="dropdown-container">
        ...
        {activeDropdown === 'clients' && ( // Check if 'clients' dropdown is active
          <ul className="dropdown-content">
            <li><a href="/viewclient">View Clients</a></li>
            <li><a href="/searchclient">Search Clients</a></li>
          </ul>
        )}
      </div>
      <div className="dropdown-container">
        <a href="#products" onClick={() => toggleDropdown('products')} className="dropdown-btn">
        <i className="fa fa-fw fa-shopping-cart"></i> Products
        </a>
        {activeDropdown === 'products' && ( // Check if 'clients' dropdown is active
          <ul className="dropdown-content">
